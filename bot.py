...
async def event(ctx, arg):
    ...
    if event == 'mafia':
        ...
        embed=discord.Embed(title=f"Проводится ивент мафия @everyone!", description=f"Победа мирных - 100 коинов\nПобеда мафии - 75 коинов\nВедущий - {ctx.author.mention}", color=0xff0084)
        ...
        embed=discord.Embed(title="Проводится ивент уно @everyone!", description=f"1 место - 100 коинов\n2 место - 75 коинов\n3 место - 50 коинов\nВедущий - {ctx.author.mention} ", color=0x40ff00)
        ...
        embed=discord.Embed(title="Проводится ивент монополия @everyone!", description=f"1 место - 350 коинов\n2 место - 300 коинов\n3 место - 150 коинов\nВедущий - {ctx.author.mention} ", color=0xffc500)
